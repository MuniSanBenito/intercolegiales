      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          <div className="rounded-2xl border border-emerald-500/20 bg-slate-900/70 p-5 backdrop-blur-md">
            ...
            <p className="text-sm leading-relaxed text-slate-400">Parque Vieytes, Complejo Oscar Chapino (Av. Jorge Newbery 5900) y Biblioteca Municipal (Av. Friuli 1051), San Benito.</p>
          </div>
